                  ...
                  <Card data-background="color" data-color="green">
                    <CardBody className="text-center">
                      ...
                      <p className="card-description">
                        ...
                        the best option to start your development.
                      </p>
                    </CardBody>
                  </Card>
                </Col>
                <Col sm="3">
                  <Card data-background="color" data-color="blue">
                    <CardBody className="text-center">
                      ...
                      <p className="card-description">
                        Using the kit will save you large amount of time. You don't have to worry about customising the
                ...
                <Col sm="3">
                  <Card data-background="color" data-color="purple">
                    <CardBody className="text-center">
                      ...
                      <p className="card-description">
                        Enjoy the fluid grid system based on 12 columns. Paper Kit PRO React is built over Reactstrap
                        and has all the benefits that the framework comes with.
                      </p>
                    </CardBody>
                  </Card>
                </Col>
                <Col sm="3">
                  <Card data-background="color" data-color="brown">
                    <CardBody className="text-center">
                      ...
                      <p className="card-description">
                        Watheia Labs primarily uses the flexbox for the layout, grid system, cards and components. This
                        is a huge advantage for working with columns.
                      </p>
                    </CardBody>
                  </Card>
                </Col>
