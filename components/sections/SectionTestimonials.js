      ...
      <Card className=" card-testimonial card-plain">
        ...
        <CardBody>
          <h5 className=" card-description">
            "I'm newer to the front-end... With my creative side lacking in experience this really put me in the right
            spot to speed through the fast lane. I love this Design kit so much!"
          </h5>
          <CardFooter>
          ...
          <Row>
            <Col className="ml-auto mr-auto text-center" md="8">
              ...
              <h5 className="description">
                The UI Kits, Templates and Dashboards that we've created are used by <b>790,000+ web developers</b> in
                over <b>1,400,00 Web Projects</b>. This is what some of them think:
              </h5>
            </Col>
          </Row>
          <Row>
