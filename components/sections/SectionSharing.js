          ...
          <Row>
            <div className="title text-center">
              ...
              <p className="description">
                You have <b>Free Unlimited Updates</b> and <b>Premium Support</b> on each package for 6 months. You also
                have <b>24 hours</b> to request a refund if you're not happy with your purchase.
              </p>
              <br />
            </div>
                  ...
                  <Card className="card-pricing">
                    <CardBody>
                      ...
                      <p className="card-description">
                        For personal websites, school projects, startups or any other project where your users will not
                        be charged for using it. Create one single website/app for one client.
                      </p>
                      <CardFooter>
                        <Button
                          className="btn-round"
                          target="_blank"
                          color="danger"
                          href="https://watheia.io/product/paper-kit-pro-react?ref=pkpr-presentation-page"
                        >
                          Get Support
                        </Button>
                      </CardFooter>
                ...
                <Col md="6">
                  <Card className="card-pricing">
                    <CardBody>
                      ...
                      <p className="card-description">
                        For business projects, multiple websites for clients or for creating themes where your users
                        will be charged for using it. Create multiple websites/apps for multiple clients.
                      </p>
                      <CardFooter>
                        <Button
                          className="btn-round"
