                ...
                <Row className="space-top">
                  <Col md="6">
                    <Button
                      ...
                      color="default"
                      href="https://gitlab.com/watheia/waweb/paper-kit-react?ref=creativetim"
                      target="_blank"
                    >
                      View Demo on Github
                    </Button>
              ...
              <Row>
                ...
                <Col md="12">
                  ...
                  <p className="description">
                    *Components: buttons, social buttons, navbars, dropdowns, tabs, tables, cards, select, tags, sliders
                    etc. and their customisation by classes.
                  </p>
                </Col>
              </Row>
            </Col>
